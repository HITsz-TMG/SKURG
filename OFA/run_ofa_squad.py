...
from OFA.ofa.modeling_squad_ofa import OFAModel_squad
import errno
...
def main():
    ...
    parser.add_argument(
        ...
        default='./MMQA/OFA/outputs/OFA_squad_base/checkpoint-latest',
        type=str,
        help="Path to pretrained model or model identifier from huggingface.co/models",
    )
    parser.add_argument(
        "--output_dir",
        default='./MMQA/OFA/outputs/OFA_squad_base',
        type=str,
    ...
    tokenizer.add_special_tokens(
        {'additional_special_tokens': ['<title>', '</title>', 'ROW', '[b_ans]', '[e_ans]', '[b_source]',
                                       '[e_source]']})
    model = OFAModel_squad.from_pretrained(args.model_name_or_path, tokenizer=tokenizer)
